...
namespace Semantic.Skills.Cognitive
{
    ...
    public class LLMSkill : BaseSkill
    {
        ...
        /// </summary>
        public override string Function => $"Allows for passing {PromptVariables.INPUT} to an OpenAI large language model and returning the model's reponse.";

        /// <summary>
        /// Overloaded constructor to provide dependencies.
        /// </summary>
        /// <param name="availableSkills">All available skills.</param>
        public LLMSkill(IEnumerable<BaseSkill> availableSkills)
