...
namespace Semantic.Core.Tests.Thoughts.Chains.Cognitive
{
    public class YouTubeShortFactualVideoGenerationChainTests
    {
        ...
        public void Constructor_WithInvalidLogger_ShouldThrow()
        {
            ...
            var actual = Assert.Throws<ArgumentNullException>(() => new YouTubeShortFactualVideoGenerationChain(serviceProvider, logger));
        ...
        public void Constructor_WithValidParams_ShouldConstruct()
        {
            ...
            var actual = new YouTubeShortFactualVideoGenerationChain(serviceProvider, logger);
        ...
        public async Task ExecuteChainAsync_WithValidInput_ShouldCallInvokeAsyncAsync()
        {
            ...
            var actual = await instance.ExecuteChainAsync(input, chainState);
