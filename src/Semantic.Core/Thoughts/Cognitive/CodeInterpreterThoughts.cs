...
namespace FrostAura.Libraries.Semantic.Core.Thoughts.Cognitive
{
    ...
    public class CodeInterpreterThoughts : BaseThought
    {
        ...
        public CodeInterpreterThoughts(ILogger<CodeInterpreterThoughts> logger)
            :base(logger)
        { }
            ...
            CancellationToken token = default)
        {
            if (!code
                    ...
                    .Contains("def main()")) throw new ArgumentException("The code block is required to contain a function called 'main' (def main()) that accepts zero arguments and returns a string.", nameof(code));
